//Activity for displaying the steps for the various instructions.
...
public class ThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(category);
        String url = "https://project-7104573469224225532.firebaseio.com/Instructions/" + category;
...
//      FireBase recycler adapter fetches data from web it checks the img for every particular step and then decides whether
//      the step has an image or not
...
//                        Filling the holder with data corresponding to each step.
                        sh.setInst(name);
                        sh.setNum(key);
                        if(val) {
...
//        Setting the properties of the RecyclerView.
        c= ThirdActivity.this;
        ...
        // Enable the Up button to the parent activity that is the FirstActivity.
        assert ab != null;
...
//    The data model that is fetched for each step from the Firebase Database.
...
//    API Indexing code not implemented yet, framework added.
    @Override
    public void onStart() {
        super.onStart();
        // ATTENTION: This was auto-generated to implement the App Indexing API.
